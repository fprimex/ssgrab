...
def get_url_monkey(package, file_id, directory_id=None, start=1, end=25):
...
def ssgrab(verbose=False,
    ...
    for f in pkg_info["files"]:
        try:
            package.download_and_decrypt_file(f["fileId"], download_directory=work_dir)
    ...
    ## Log the cfg
    #vp.print('Running with ssgrab config:\n'
    #        ' verbose: {}\n'
    #        ' tickets: {}\n'
    #        ' work_dir: {}\n'
